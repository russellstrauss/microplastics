...
module.exports = function () {
  return {
    ...
    myMethod: function myMethod() {
      var circle = d3.select('.monument-visualization').append("svg").attr("width", 600).attr("height", 400);
      var circles = circle.append("circle").attr("cx", 300).attr("cy", 150).style("fill", "blue").attr("r", 100);
    }
  };
};
