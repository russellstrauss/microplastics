...
module.exports = function () {
  ...
  return {
    ...
    myMethod: function myMethod() {
      ...
      var BelowText = d3.select('.monument-visualization').append("svg").attr("class", "texts").attr('id', 'plasticProduction').attr("width", 1200).attr("height", 140);
      plasticProductionTextField = BelowText.append('text').attr('x', 200).attr('y', 100).style('fill', 'black').style('font-size', '1.2em').text('Plastics Amount');
      BelowText.append('text').attr('x', 580).attr('y', 105).style('fill', 'black').style('font-size', '2em').text("=");
      var monumentText = BelowText.append('text').attr('x', 845).attr('y', 100).style('fill', 'black').text('Real World').style('font-size', '1.2em'); /////////////////////////////////////////////
      ...
      function update(h) {
        ...
        Object.keys(plasticProductionData).forEach(function eachKey(key) {
          ...
          if (parseInt(plasticProductionData[key].Year) === parseInt(year)) {
            ...
            var monumentImages = document.querySelectorAll('.monument-visualization img');
