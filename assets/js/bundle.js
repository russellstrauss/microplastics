...
},{"leaflet-arc":8}],3:[function(require,module,exports){
"use strict";
...
module.exports = function () {
  ...
  return {
    ...
    sunburst: function sunburst() {
      ...
      var width = document.querySelector('.sunburst .sunburst-container').offsetWidth;
      var radius = width / 6;
    ...
    updateStats: function updateStats(newRoot, parent) {
      ...
      newRoot.forEach(function (child) {
        ...
        var regionElement = document.createElement('div'),
          ...
          regionNameElement = document.createElement('div');
...
},{"./components/horizontal-bar.js":1,"./components/maps.js":2,"./components/plastic-longevity.js":3,"./components/projections.js":4,"./components/sunburst.js":5,"./utils.js":7}],7:[function(require,module,exports){
"use strict";
